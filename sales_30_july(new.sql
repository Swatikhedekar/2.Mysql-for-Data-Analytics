...
#alter table sales1 drop column order_date_new ;
#alter table sales1 drop column flag ;
...
select dayname('2023-02-23 21:10:30');
...
/*load data infile 
'C:\Users\user\AS\FSDA\live\mysql\resourse\dataset11/sales_data_final.csv'
into table sales 
fields terminated by ','
enclosed by '"'
lines terminated by '\n'
