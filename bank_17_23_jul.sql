...
select `day` from bank_details;
select `month` from bank_details;
...
/* Only those records having age=60 and retired */

select * from bank_details where age=60 and job = 'retired';

/* Find Only those records having education = unknown or married status is single */
select * from bank_details where education = "unknown" or marital="single";

/* Find Only those records having married status is single and balance < 500 */
select * from bank_details where marital="single" or balance < 500 ;

/* Find Only those records having married status is unknown or balance < 500 */
select * from bank_details where marital="unknown" or balance < 500 ;

/* Find Only those records having education=unknown or married status is single and balance < 500 */

select * from bank_details where (education = "unknown" or marital="single") and balance < 500 ;

/* Find ercords having distinct job types*/

select distinct job from bank_details ;

/* Arrange a data into ascending order by age by using " order by" */

select * from bank_details order by age ;

/* Arrange a data into descending order by age by using " order by" */
...
#4.try to find out who is having a maximim balance 
...
select count(*) balance,housing from bank_details where housing ='no';
